   ...
   $query = "select LPAD(a.id_asiento,6,'0'), ".
			 ...
			 "where a.estado_autorizacion = 1 ".
			   ...
			   "and a.id_asiento = case when '".$_POST['idNumAsiento']."' = 0 then a.id_asiento else '".
	            ...
	            "and DATE(DATE_FORMAT(a.fecha_asiento,'%d/%m/%Y')) >= '".$_POST['fechaDesde']."' ".
	            "and DATE(DATE_FORMAT(a.fecha_asiento,'%d/%m/%Y')) <= '".$_POST['fechaHasta']."' ".
