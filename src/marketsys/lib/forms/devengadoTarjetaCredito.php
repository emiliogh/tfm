				...
				<thead>
					<tr>
						<td colspan="7" class="estilo3">
							Devengado de tarjeta de crédito
						</td>
					</tr>
				</thead>
				<tbody>
				    ...
				    <div class="row form-group">
						<div style="width: calc(100% - 60px); margin-left: 30px;" id="calificacionDiv">
							<table class="table" style="width: 100%;">
								...
								<tr>
									<td style="width: 160px;"><b>Tipo de transacción:</b>
									</td>	
									<td colspan="3"><span id="numeroTransaccion"></span></td>	
								</tr>
								<tr>
									<td><span id="tipo"><b>Monto transacción:</b></span>
									</td>	
									<td colspan="3"><span id="montoTransaccion"></span></td>	
								</tr>
								<tr>
									<td><b>Documento Bancario:</b>
									</td>	
									<td><input id="numeroDocumentoBancario" name="numeroDocumentoBancario" autocomplete="off" type="text" 
											   class="form-control" style="width: 100%; height: 24px; text-align: right;" 
											   onkeypress="return soloNumerosDecimales(event)"/>
									</td>
									<td><b>Comisión:</b>
									</td>	
									<td><input id="comisionMovBancario" name="comisionMovBancario" autocomplete="off" type="text" 
											   class="form-control" style="width: 100%; height: 24px; text-align: right;" 
											   onkeypress="return soloNumerosDecimales(event)"/>
									</td>
								</tr>
								<tr>
									...
									<td><input id="retencionIR" name="retencionIR" autocomplete="off" type="text" 
											   class="form-control" style="width: 100%; height: 24px; text-align: right;" 
											   onkeypress="return soloNumerosDecimales(event)"/>
									</td>
									<td><b>Retensión IVA:</b>
									</td>	
									<td><input id="retencionIVA" name="retencionIVA" autocomplete="off" type="text" 
											   class="form-control" style="width: 100%; height: 24px; text-align: right;" 
											   onkeypress="return soloNumerosDecimales(event)"/>
									</td>
								</tr>
								<tr>
									...
									<td colspan="3"><textarea id="observacionMovimiento" name="observacionMovimiento" autocomplete="off" type="text" 
...
<script>
	...
	var cmb=new componente.cmb
		...
		cmb.loadFromUrlAd('../cmb/cmbCuentasTarjetaCredito.php')
	...
	function consultaMovimientos(){
		...
		if (document.getElementById("cmbCuentasBancarias").value != -1){
