			...
			<table style="width: 99.9%;">
				...
				<tbody>
					<tr>
						...
						<td class="clsObjetosTable" rowspan="5" style="width: 280px;">
					...
					<tr>
						...
						<td>
							<input id="fechaFactura" type="text" 
								   style="width: 99%; height: 18px; font-size: 13px; text-align: center;"/>
						</td>
						<td class="clsEtiquetasTable">
							N° de Factura:
					    </td>
						<td class="clsObjetosTable">
							<table style="width: 100%;">
								<tr>
									<td style="width: 20%;">
										<input id="numFacturaEstablecimiento" type="text" autocomplete="off"
											   style="width: 100%; height: 18px; font-size: 12px; text-align: center;"/>
									</td>
									<td style="width: 20%;">
										<input id="numFacturaPuntoEmision" type="text" autocomplete="off"
											   style="width: 100%; height: 18px; font-size: 12px; text-align: center;"/>
									</td>
									<td style="width: 60%;">
										<input id="numFactura" type="text" type="text" autocomplete="off"
											   style="width: 100%; height: 18px; font-size: 12px; text-align: center;"/>
									</td>
								</tr>
							</table>
					...
					<tr>
						...
						<td class="clsEtiquetasTable" style="width: calc(100% - 400px); padding-left: 0px;">
							<table style="width: 100%;">
								<tr>
									<td class="clsEtiquetasTable" style="width: 130px;">
										N° de autorización:
									</td>
									<td class="clsObjetosTable">
										<input id="numAutorizacion" name="numAutorizacion" class="required" type="text" 
											   autocomplete="off" style="width: 100%; height: 18px;"/>
									</td>
								</tr>
							</table>
						</td>
						<td class="clsEtiquetasTable" style="width: calc(100% - 400px); padding-left: 5px;">
							   ...
							   <tr>
									<td style="width: 80px; padding-top: 5px; padding-bottom: 5px;">
										...
										<input id="descripcionProducto" name="descripcionProducto" type="text" 
											   style="display: none;"/>
										<input id="precioVenta" name="precioVenta" type="text" style="display: none;"/>
										<input id="idGrabaIVA" name="idGrabaIVA" type="text" style="display: none;"/>
										<input id="idCuentaContable" name="idCuentaContable" type="text" style="display: none;"/>
										<input id="idRetencionRenta" name="idRetencionRenta" type="text" style="display: none;"/>
										<input id="idRetencionIVA" name="idRetencionIVA" type="text" style="display: none;"/>
									</td>
									<td>
										<input id="item" name="item" class="required" type="text" 
											   style="width: 100%; height: 26px;" autocomplete="off"
											   onfocus="cargarIformacionProductos();"/>
									</td>
				    ...
				    <div class="row form-group">
						<div style="width: calc(100% - 70px); margin-left: 30px;" id="calificacionDiv">
							<table class="table" style="width: 100%;">
								...
								<tr>
									<td><span id="tipo">Nombre Comercial</span>
									</td>	
								...
								<tr>
									<td><span id="tipo">Razón Social</span>
									</td>	
									<td><input id="razonSocialNw" name="razonSocialNw" autocomplete="off" type="text" 
											   class="form-control"
											   style="width: 100%; height: 22px; text-transform: uppercase;" 
											   onkeypress="return soloLetras(event)"/>
									</td>	
			    ...
			    <div class="modal-body" style="height: 250px; "> <!-- CUERPO DEL MENSAJE -->
				    <div class="row form-group">
						<div style="width: calc(100% - 70px); margin-left: 30px;" id="calificacionDiv">
							<table style="width: 100%;">
								<tr>
									<td style="display:none; width: 50%; text-align: center;">
										Archivo XML
								...
								<tr>
									<td style="display:none; width: 50%; text-align: center; padding-left: 25px">
						...
						<div style="width: calc(100% - 70px); margin-left: 30px;" id="calificacionDiv">
							<table class="table" style="width: 100%;">
								...
								<tr>
									...
									<td><input id="precioVentaNw" name="precioVentaNw" autocomplete="off" type="text" 
											   class="form-control"
								...
								<tr>
									...
									<td><input type="checkbox" id="chkGIVANw" checked data-toggle="toggle" data-on="SI" 
											   data-off="NO" data-size="mini">
									</td>
								</tr>
								<tr>
									<td style="width: 120px;">Cuenta Contable
									</td>	
									<td colspan="3">
										<input id="idcuentaContableNw" type="text" style="display: none;"/>
					              		<input id="cuentaContableNw" name="item'+sec+'" class="required" type="text" 
											   style="width: 100%; height: 26px;"/>
									</td>
								</tr>
								<tr>
									<td>Retención a la Fuente
									</td>	
									<td colspan="3"><select id="retencionFuenteNw" style="width: 100%;"></select>
									</td>	
								</tr>
								<tr>
									<td>Retención al IVA
									</td>	
									<td colspan="3"><select id="retencionIVANw" style="width: 100%;"></select>
									</td>	
								</tr>
							</table>	
						</div>	
		   ...
		   <div class="modal-dialog" role="document">
			 <div class="modal-content">
			   ...
			   <div class="modal-footer"> <!-- PIE -->
				    ...
				    <button class="btn btn-default btn btn-danger btn-lg" type="button" data-dismiss="modal" 
							onClick="cancelarPagosPersonalizados();">Cerrar </button>
			   </div>
			</div>
		</div>
	</div>
...
<script>
	...
	$.ajax({
		...
		success:function(data){
			...
			$( "#cliente" ).on( "autocompleteselect", function( event, ui ) {
				document.getElementById('idCliente').value = ui.item[1];
				document.getElementById('identificacion').value = ui.item[3];
				document.getElementById('cliente').value = ui.item[4];
				document.getElementById('nombreComercial').value = ui.item[5];
				document.getElementById('direccion').value = ui.item[6];
				
				//document.getElementById('email').value = ui.item[6];
				document.getElementById('idTipoCliente').value = ui.item[9];
				document.getElementById('idCategoriaCliente').value = ui.item[10];
				document.getElementById('idPorcentajeCategoria').value = ui.item[11];
		...
		if ($("#idItem").val() != ''){
			...
			/*				= ui.item[0];
									 	= ui.item[2];
									 		...
									 		= ui.item[7];*/
			let sec = indx;
			let cod = document.getElementById('idItem').value;
			let des = document.getElementById('descripcionProducto').value;
			let cnt = 0;
			let pun = parseFloat(document.getElementById('precioVenta').value);
			let gIv = document.getElementById('idGrabaIVA').value;
			let dct = 0;
			let psi = 0;
			let tim = 0.00;
			let cct = document.getElementById('idCuentaContable').value;
			let iRt = document.getElementById('idRetencionRenta').value;
			let iIV = document.getElementById('idRetencionIVA').value;
			let tabla = '';
			tabla = tabla+'<tr><td id="sc'+sec+'" style="text-align: center;">'+sec+
							...
							'</td><td id="cn'+sec+'" style="text-align: right;">'+
								'<select id="idCuenta'+sec+'" style="color: royalblue; width: 100%; font-size: 12px; border: none;" '+
									'></select>'+
							'</td><td>'+
							'<input id="ct'+sec+'" name="ct'+sec+'" onChange="calcularValores(this,'+pun+')" '+
								'type="text" style="text-align: right; width: 100%; height: 25px;" autocomplete="off" '+
								'onkeypress="return filterFloat(event,this);" ondblclick="limpiarValor(this)" value="0.00"/>'+
							'</td><td>'+
							     '<input id="pu'+sec+'" name="pu'+sec+'" class="required" '+
								 'onChange="calcularValores(this,'+pun.toFixed(2)+')" style="text-align: right; width: 100%; height: 25px;" '+
									'value="'+pun.toFixed(2)+'" onkeypress="return filterFloat(event,this);" autocomplete="off" />'+
								 '<span id="giv'+sec+'" style="display: none;">'+gIv+'</span>'+
							...
							'</td><td style="text-align: right;">'+
								'<select id="rtIva'+sec+'" style="color: royalblue; width: 100%; font-size: 12px; border: none;" '+
									'onChange="calculaRetIvaLinea('+sec+')"></select>'+
							...
							'</td><td style="text-align: right;">'+
								'<select id="rtRen'+sec+'" style="color: royalblue; width: 100%; font-size: 12px; border: none;" '+
									'onChange="calculaRetRetLinea('+sec+')"></select>'+
							'</td><td id="vr'+sec+'" style="text-align: right;">0.00</td></tr>';
			
			$("#tablaAperturaBody").append(tabla);
			let cmbRetRet = new componente.cmb;
				cmbRetRet.ini('rtRen'+sec);
				cmbRetRet.loadFromUrlMod('../cmb/cmbTscRetencionesCompraRenta.php',{v: iRt});

			let cmbRetIva = new componente.cmb; 
				cmbRetIva.ini('rtIva'+sec);
				cmbRetIva.loadFromUrlMod('../cmb/cmbTscRetencionesCompraIVA.php',{v: iIV});

			let cmbCtaCon = new componente.cmb; 
				cmbCtaCon.ini('idCuenta'+sec);
				cmbCtaCon.loadFromUrlMod('../cmb/cmbCatalogoContableDetalle.php',{v: cct});
	...
	function EliminarFila (r){
		...
		var TotRedu = document.getElementById("pv"+id).value;
		...
		sumarDetalleFactura();
		calculaRetIva(document.getElementById("rtIva"+id),id,document.getElementById("il"+id).innerHTML);
		calculaRetRet(document.getElementById("rtRen"+id),id,document.getElementById("pv"+id).innerHTML);
	}
	...
	function calcularValores(r,val){
		var i = r.parentNode.parentNode.rowIndex;
		var id = document.getElementById("tableMovimientos").rows[i].cells[0].innerHTML;
		var CantMov = document.getElementById("ct"+id).value;
		var CostMov = document.getElementById("pu"+id).value;
		var sTotal  = parseFloat(CantMov)*parseFloat(CostMov);
		    sTotal  = parseFloat(sTotal).toFixed(2);
		    document.getElementById("pv"+id).innerHTML = sTotal;
		    
		    if (document.getElementById("giv"+id).innerHTML == 1){
				document.getElementById("il"+id).value;
				iva = parseFloat(sTotal)*document.getElementById("porcentajeIVA").value/100;
				document.getElementById("il"+id).innerHTML = iva.toFixed(2);
				}
	...
	function registraNuevoCliente(){
		var cmbTiposClientes = new componente.cmb; 
			...
			cmbTiposClientes.loadFromUrl('../cmb/cmbTiposProveedores.php');
		
		var cmbCategoriasClientes = new componente.cmb; 
			cmbCategoriasClientes.ini('categoriasClientesNw');
			cmbCategoriasClientes.loadFromUrlAd('../cmb/cmbCategoriasProveedores.php');
	...
	function registraNuevoProducto(){
		if (document.getElementById('idCliente').value == '' || document.getElementById('idCliente').value == 0){
			parent. modalAlertPrincipal(3,  'MarketSys [Advertencia]', 
											'No puede cargar los productos sin seleccionar primero el proveedor.', 0, 
											'Aceptar', '');
			return;
			}
		
		let cmbRetRet = new componente.cmb;
			cmbRetRet.ini('retencionFuenteNw');
			cmbRetRet.loadFromUrlAd('../cmb/cmbTscRetencionesCompraRenta.php');

		let cmbRetIva = new componente.cmb; 
			cmbRetIva.ini('retencionIVANw');
			...
			$.ajax({
				...
				data:'id=1',
				success:function(data){
					$( "#cuentaContableNw").autocomplete({
						source: eval(data)
					});
					$( "#cuentaContableNw").on( "autocompleteselect", function( event, ui ) {
						document.getElementById('idcuentaContableNw').value = ui.item[2];
			...
			document.getElementById('precioVentaNw').value 		= '0.00';
		    document.getElementById("chkGIVANw").checked			= true;
			document.getElementById('idcuentaContableNw').value = '';
			document.getElementById('cuentaContableNw').value 	= '';
			document.getElementById('retencionFuenteNw').value 	= 0;
			document.getElementById('retencionIVANw').value 	= 0;
	...
	function guardarNuevoProducto(){
		parent.document.getElementById('divLoadding').style.display = 'block';
			...
			var detalleNW     = document.getElementById('detalleProductoNw').value;
			var precioVenta   = document.getElementById('precioVentaNw').value;
		    var chkGrabaIVA   = document.getElementById("chkGIVANw").checked;
			var idCuenta      = document.getElementById('idcuentaContableNw').value;
			var retencionRta  = document.getElementById('retencionFuenteNw').value;
			var retencionIVA  = document.getElementById('retencionIVANw').value;

		$.ajax({type:'POST',
				url:'../php/registraProductoNuevoCompra.php',
				data:'descripcion='+descripcion+'&detalleNW='+detalleNW+'&precioVenta='+precioVenta+'&chkGrabaIVA='+chkGrabaIVA+
					 '&idCuenta='+idCuenta+'&retencionRta='+retencionRta+'&retencionIVA='+retencionIVA+'&idCliente='+idCliente,
				success:function(data){
					data = eval(data);
					if (data[0] == 0){
						...
						var url = '../../lib/cmb/cmbTivItemsCompraAutoComplete.php';
						document.getElementById('idItem').value = '';
						document.getElementById('item').value = '';
						$.ajax({
							type:'POST',
							url:url,
							data:'id='+document.getElementById('idCliente').value,
							success:function(data){
								$( "#item" ).autocomplete({
								  source: eval(data)
								});
								$( "#item" ).on( "autocompleteselect", function( event, ui ) {
									...
									document.getElementById('descripcionProducto').value 	= ui.item[2];
									document.getElementById('precioVenta').value 			= ui.item[3];
									document.getElementById('idGrabaIVA').value 			= ui.item[4];
									document.getElementById('idCuentaContable').value 		= ui.item[5];
									document.getElementById('idRetencionRenta').value 		= ui.item[6];
									document.getElementById('idRetencionIVA').value 		= ui.item[7];
	...
	function guardarNuevoCliente(){
        ...
        var razonSocial  = document.getElementById("razonSocialNw").value;
		...
		$.ajax({type:'POST',
				url:'../php/registraProveedorNuevo.php',
				...
				'&telefonoClie='+telefonoClie+'&emailCliente='+emailCliente+'&razonSocial='+razonSocial,
				success:function(data){
					data = eval(data);
					if (data[0] == 0){
					    parent. modalAlertPrincipal(3, 'MarketSys [Transacción Éxitosa]', 
						...
						parent. modalAlertPrincipal(1, 'MarketSys [Información Registrada]', 
												   	   'El proveedor identificado se encuentra registrado en el sistema', 0, 
												   	   'Aceptar', '');
						document.getElementById("tiposClientesNw").value 		= 0;
						document.getElementById("categoriasClientesNw").value 	= 0;
						document.getElementById("tiposIdentificacionNw").value 	= 0;
	...
	function cargarIformacionProductos(){
		var indx = 0;
		var url = '../../lib/cmb/cmbTivItemsCompraAutoComplete.php';
		if (document.getElementById('idCliente').value == '' || document.getElementById('idCliente').value == 0){
			parent. modalAlertPrincipal(3,  'MarketSys [Advertencia]', 
							...
							$.ajax({type:'POST',
							 ...
							 for (var i = 2; i < tableReg.rows.length-1; i++)
								 {if (i == 2){inicio = 1; d = d.getTime();}else{inicio = 0;}
								  ...
								  var cantidadP = document.getElementById("ct"+idMovi).value;
								  var precioUni = document.getElementById("pu"+idMovi).value;
	...
	function calculaRetRetLinea(id){
		//console.log(elem +' * '+elem.value +' * '+ id +' * '+ pventa)
		if (document.getElementById('rtRen'+id).value == 0){
			document.getElementById('vr'+id).innerHTML = '0.00';
			document.getElementById('rtRen'+id).style.color = 'royalblue';
		}else{
			porceRet = $('option:selected', document.getElementById('rtRen'+id)).attr('codigo');
		    //console.log(porceRet);
			valorRet = parseFloat(porceRet)*parseFloat(document.getElementById('pv'+id).innerHTML)/100;
			//console.log(valorRet);
		    valorRet = valorRet.toFixed(2);
		    document.getElementById('vr'+id).innerHTML = valorRet;
			document.getElementById('rtRen'+id).style.color = 'black';}
	...
	function calculaRetIvaLinea(id){
		//console.log(elem +' * '+elem.value +' * '+ id +' * '+ pventa)
		if (document.getElementById('rtIva'+id).value == 0){
			document.getElementById('ir'+id).innerHTML = '0.00';
			document.getElementById('rtIva'+id).style.color = 'royalblue';
		}else{
			porceRet = $('option:selected', document.getElementById('rtIva'+id)).attr('codigo');
			valorRet = parseFloat(porceRet)*parseFloat(document.getElementById('il'+id).innerHTML)/100;
			valorRet = valorRet.toFixed(2);
			document.getElementById('ir'+id).innerHTML = valorRet;
			document.getElementById('rtIva'+id).style.color = 'black';}
    ...
    function sumarDetalleFactura(){
		tableReg = document.getElementById('tablaAperturaBody');
		   	let sumSinImp = 0;
		    let sumConImp = 0;
		    let sumImp = 0;
		        for(i = 0; i< tableReg.rows.length; i++) {
					 let id = document.getElementById("tablaAperturaBody").rows[i].cells[0].innerHTML;
					 if (document.getElementById("giv"+id).innerHTML == 1){
						 sumConImp = sumConImp +parseFloat(document.getElementById("pv"+id).innerHTML);
						 sumImp    = sumImp    +parseFloat(document.getElementById("il"+id).innerHTML);
						}else{
							sumSinImp = sumSinImp +parseFloat(document.getElementById("pv"+id).innerHTML);
						}
				}
		
			let subtotal = parseFloat(sumConImp) + parseFloat(sumSinImp);
			document.getElementById("txtSubtotalVenta").innerHTML  = subtotal.toFixed(2);
			document.getElementById("txtVTotalIVA0").innerHTML  = parseFloat(sumSinImp).toFixed(2);
			document.getElementById("txtVTotalIVA12").innerHTML = parseFloat(sumConImp).toFixed(2);
			document.getElementById("txtTotalIVA12").innerHTML = parseFloat(sumConImp).toFixed(2);
		    let total = parseFloat(subtotal) + parseFloat(sumImp);
		    document.getElementById("txtTotalVenta").innerHTML = parseFloat(total).toFixed(2);
	...
	/*function validar() {
        var cad = document.getElementById("numeroIdentificacionNw").value.trim();
		var tip = document.getElementById("tiposIdentificacionNw").value; 
        var total = 0;
        var longitud = cad.length;
		if (tip == 1){
			if (longitud!=10){
				parent. modalAlertPrincipal(1, 'MarketSys [Error]', 
									           'El número de digitos no es el correcto para el número de cédula registrado. ', 0, 
									           'Aceptar', '');
				return;
				}
			}
		if (tip == 2){
			if (longitud!=13){
				parent. modalAlertPrincipal(1, 'MarketSys [Error]', 
									           'El número de digitos no es el correcto para el número de RUC registrado. ', 0, 
									           'Aceptar', '');
				return;
				}
			}
