...
<body bgcolor="#fff" style="left: 0px;" onLoad="consultaMovimientos(); parent.document.getElementById('divLoadding').style.display = 'none';">
				...
				<thead>
					<tr>
						<td colspan="5" class="estilo3">
							CONSULTA DE ASIENTOS NO CONTABILIZADOS
						</td>
					</tr>
				</thead>
				<tbody>
					<tr>
						...
						<td colspan="3" class="clsObjetosTable">
							<select name="cmbTiposAsientos" id="cmbTiposAsientos" style="width: 100%; height: 22px;">
							  <option value="0" SELECTED>Seleccione una Opción.</option>
							</select>
						</td>
						<td rowspan="3" style="width: 120px;">
							<button type="button" onClick="consultaMovimientos();" style="width: 100%;">
								<img src="../images/icons/busqueda.png" width="29px" alt=""/><br>Consultar Asientos</button>
					    </td>
					</tr>
					<tr>
						<td class="clsEtiquetasTable" style="width: 150px;">
						...
						<td colspan="3" class="clsObjetosTable">
							<select name="cmbDetalleAsiento" id="cmbDetalleAsiento" style="width: 100%; height: 22px;">
							  <option value="0" SELECTED>Seleccione una Opción.</option>
							</select>
						</td>	
					</tr>
					...
					<tr>
						<td colspan="5" class="estilo3">
							DETALLES DE LOS ASIENTOS NO CONTABILIZADOS
						</td>
					</tr>
					<tr>
						<td colspan="5" class="estilo3">
...
<script>
	...
	function consultaMovimientos(){
		...
		var url = '../php/retornaAsientosNoContabilizados.php';
		...
		$.ajax({
			type:'POST',
			url:url,
			data:'idTipoAsiento='+idTipoAsiento+'&idNumAsiento='+idNumAsiento+
