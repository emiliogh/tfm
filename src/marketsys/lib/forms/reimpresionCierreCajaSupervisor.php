...
<head>
  ...
  <title>Reimpresión de Cierre de Caja</title>
				...
				<tbody>
					<tr>
						...
						<td colspan="3" class="clsObjetosTable">
							<select name="idEstablecimiento" id="idEstablecimiento" style="height: 20px; width: 100%">
						...
						<td rowspan="4" style="width: 120px;">
							<button type="button" onClick="consultaMovimientos();" style="width: 100%;">
								<img src="../images/icons/busqueda.png" width="29px" alt=""/><br><br>Consultar Facturas</button>
					    </td>
					</tr>
					<tr>
						<td class="clsEtiquetasTable" style="width: 150px;">
						...
						<td colspan="3" class="clsObjetosTable">
							<select name="idPuntoEmision" id="idPuntoEmision" style="height: 20px; width: 100%">
					...
					<tr>
						...
						<td colspan="3" class="clsObjetosTable">
							<select name="idCajero" id="idCajero" style="height: 20px; width: 100%">
							  <option value="0" SELECTED>Seleccione una opción.</option>
							</select>
						</td>
					</tr>
					...
					<tr>
						<td colspan="5" class="estilo3">
							DETALLES DE CIERRE DE CAJA PARA REIMPRESIÓN
						</td>
					</tr>
					<tr>
						<td colspan="5" class="estilo3">
...
<script>
	...
	function consultaMovimientos(){
		...
		var url = '../php/retornaInformacionCierresCaja.php';
		...
		$.ajax({
			type:'POST',
			url:url,
			data:'idEstablecimiento='+idEstablecimiento+'&idPuntoEmision='+idPuntoEmision+
				 '&idCajero='+idCajero+'&fechaDesde='+fechaDesde+'&fechaHasta='+fechaHasta,
