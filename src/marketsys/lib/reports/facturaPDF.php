...
class PDF extends FPDF
{
	...
	{	
		...
		$db = new MySQL();
		$query = "select distinct(e.numero_identificacion), ".
						"e.razon_social, ". 
						"e.abreviatura, ".
			            "s.direccion, ".
						"s.direccion, ".
		...
		if($numResul>0){
			while($resultados = $db->fetch_array($consulta)){ 
				...
				$this->SetY(57); $this->SetX(8);$this->SetFont('helvetica','',8);
				$this->Cell(110,4,utf8_decode('Contribuyente Régimen RIMPE'),0,1,'C',false);
